                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="text-codedex-gold text-xs font-pixel">
                        {exercise.isBonus ? 'Artículo Extra' : 'Pack de Desafíos'}
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                      {exercise.isLocked ? (
                        <div className="flex items-center gap-1 text-gray-500 text-xs">
                          <Lock size={12} />
                          <span>Completa el capítulo para desbloquear</span>
                        </div>
                      ) : (
              ...
              <div className="pl-12 pt-4 border-t border-codedex-gold/10 mt-4">
                ...
                <ul className="space-y-2">
                  {requirements.map((req, index) => (
                    <li key={`requirement-${index}`} className="flex items-center gap-2 text-sm text-gray-400">
            ...
            {isFinalProject && (
              <div className="pl-12 pt-4 mt-4 text-center">
                <div className="text-gray-400 text-sm">
                  Completa todos los ejercicios para desbloquear el Proyecto Final
                </div>
              </div>
            )}
          </ul>
