    ...
    <div className="relative py-16 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-b from-codedex-darkNavy/0 to-codedex-darkNavy"></div>
      </div>
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-wrap gap-4">
            <Button
              ...
              asChild
            >
              <Link href={`/python/01-setting-up`}>Comienza a Aprender Gratis</Link>
            </Button>
          </div>
        </div>
      </div>
