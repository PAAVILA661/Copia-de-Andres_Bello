...
const DifficultyBadge: React.FC<{ difficulty: string }> = ({ difficulty }) => {
  const colors = {
    PRINCIPIANTE: 'bg-codedex-teal',
    INTERMEDIO: 'bg-codedex-blue',
    AVANZADO: 'bg-codedex-purple',
  };
    ...
    <Card className="bg-codedex-navy border border-codedex-gold/20 overflow-hidden transition-transform hover:translate-y-[-4px] duration-300">
      ...
      <CardContent className="p-6 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <Button variant="ghost" className="border border-codedex-gold/30 text-codedex-gold hover:bg-codedex-gold/10 hover:text-white" asChild>
