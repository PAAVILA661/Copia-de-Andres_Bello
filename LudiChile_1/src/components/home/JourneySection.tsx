...
const JourneySection = () => {
  const pythonCourses = [
    {
      title: 'Python',
      description: '¡Aprende los fundamentos de la programación como variables, control de flujo y bucles con el lenguaje de programación más popular y versátil del mundo — Python!',
    ...
    <section className="py-16 bg-codedex-darkNavy">
      <div className="codedex-container">
        <div className="flex items-center gap-4 mb-8">
          <h2 className="text-3xl font-pixel text-codedex-gold">Tu Viaje</h2>
          <div className="h-px bg-codedex-gold/20 flex-grow"></div>
        </div>
        ...
        <div className="flex flex-wrap gap-4 mb-8">
          <Button variant="outline" className="border-codedex-gold/30 text-codedex-gold bg-transparent hover:bg-codedex-gold/10 hover:text-white">
            Popular
          </Button>
          <Button variant="ghost" className="text-gray-400 hover:text-white hover:bg-codedex-gold/10">
            Desarrollo Web
          </Button>
          <Button variant="ghost" className="text-gray-400 hover:text-white hover:bg-codedex-gold/10">
            Ciencia de Datos
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {pythonCourses.map((course, index) => (
            <CourseCard
              ...
              difficulty={course.difficulty as 'PRINCIPIANTE' | 'INTERMEDIO' | 'AVANZADO'}
              href={course.href}
              index={index + 1}
            />
          ))}
