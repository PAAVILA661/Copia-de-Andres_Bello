  ...
  const testimonials = [
    {
      ...
      quote: "Codedex ayudó a reavivar mi pasión por la programación después del Hackathon Navideño. Desde entonces me he conectado con personas que comparten intereses similares a los míos. Se siente como en casa.",
    ...
    },
    {
      ...
      location: "Singapur",
      quote: "La comunidad Codedex se siente como una reconfortante taza de té matcha caliente en un día frío y lluvioso. Es un espacio cálido y acogedor para estar a pesar de nuestros diversos orígenes y comienzos.",
